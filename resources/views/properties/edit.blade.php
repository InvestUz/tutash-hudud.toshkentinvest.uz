        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="owner_company" value="{{ old('owner_company', $property->owner_company) }}"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                    @error('owner_company')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
        ...
        <div class="mb-8">
            ...
            <div id="tenantFields" class="grid grid-cols-1 md:grid-cols-2 gap-4 {{ old('has_tenant', $property->has_tenant) ? '' : 'hidden' }}">
                ...
                <div>
                    ...
                    <input type="text" name="tenant_company" value="{{ old('tenant_company', $property->tenant_company) }}"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
