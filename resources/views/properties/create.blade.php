            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" placeholder="Iltimos (STIR/PINFL yordamida Tekshirish tugmasini bosib to'ldiring" name="owner_name" id="owner_name" value="{{ old('owner_name') }}" required
